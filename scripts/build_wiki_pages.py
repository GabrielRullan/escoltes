...
<div style="background-color: var(--md-code-bg-color, #f8f9fa); padding: 18px; border-radius: 10px; border: 1px solid #e0e0e0; margin-bottom: 24px;">
    ...
    <div style="display: flex; gap: 10px; align-items: center;">
        <input type="text" id="filter-search" oninput="applyRouteFilters()" placeholder="🔎 Cercar per nom, paratge o paraula clau..." style="flex: 1; padding: 8px 12px; border-radius: 6px; border: 1px solid #ccc;" />
...
function applyRouteFilters() {{
    ...
    const filtered = allRoutes.filter(r => {{
        ...
        return matchMun && matchZon && matchDif && matchBra && matchTxt;
    }});
