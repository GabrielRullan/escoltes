# ⛺ Casa de s'Alzina (Albarca)

Refugi rehabilitat a la finca d'Albarca.

---

## 🗺️ Mapa Interactiu (OpenStreetMap)

<iframe width="100%" height="350" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://www.openstreetmap.org/export/embed.html?bbox=3.324%2C39.7385%2C3.354%2C39.7595&amp;layer=mapnik&amp;marker=39.749%2C3.339" style="border: 1px solid #ddd; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);"></iframe>
<p style="margin-top: 4px; margin-bottom: 16px;"><small><a href="https://www.openstreetmap.org/?mlat=39.749&amp;mlon=3.339#map=15/39.749/3.339" target="_blank">🗺️ Obrir mapa complet a OpenStreetMap</a></small></p>
...
| **Accés d'Emergència** | **Pista forestal des de s'Alqueria Vella** |

---

## 🛠️ Infraestructura disponible
- **Serveis:** Aigua, Cuina, Lavabo
...
| :--- | :--- | :---: | :--- |
| **AEG Sa Marjal** | Sa Pobla | **27.0 km** | [Veure Casal](../agrupaments/aeg-sa-marjal.md) |
