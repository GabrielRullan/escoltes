...
Refugi rehabilitat al poble de Deià.

---

## 🗺️ Mapa Interactiu (OpenStreetMap)

<iframe width="100%" height="350" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://www.openstreetmap.org/export/embed.html?bbox=2.6332999999999998%2C39.7386%2C2.6633%2C39.7596&amp;layer=mapnik&amp;marker=39.7491%2C2.6483" style="border: 1px solid #ddd; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);"></iframe>
<p style="margin-top: 4px; margin-bottom: 16px;"><small><a href="https://www.openstreetmap.org/?mlat=39.7491&amp;mlon=2.6483#map=15/39.7491/2.6483" target="_blank">🗺️ Obrir mapa complet a OpenStreetMap</a></small></p>
...
| **Municipi** | **Deià** |
| **Capacitat Màxima** | **32 persones** |
| **Antelació Permís** | **Reserva online via Consell de Mallorca** |
| **Contacte / Reserves** | **971 63 61 86 / 971 18 20 27** |
| **Accés d'Emergència** | **Accés vehicle des de Deià** |
...
| :--- | :---: | :---: | :---: | :--- |
| **GR-221 Etapa 5: Deià al Port de Sóller** | 10.2 km | Fàcil - Moderada | **0.00 km** (🟢 A peu) | [Veure Ruta](../rutes/gr221-etapa-5-deia-port-soller.md) |
| **Camí des Rafal i Cova de sa Cauba (Deià)** | 6.5 km | Moderada | **0.49 km** (🟢 A peu) | [Veure Ruta](../rutes/cami-des-rafal-deia.md) |
| **Sa Foradada des de Son Marroig (Deià)** | 7.0 km | Moderada | **1.75 km** (🟢 A peu) | [Veure Ruta](../rutes/sa-foradada-son-marroig.md) |
