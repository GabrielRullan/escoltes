...
Refugi d'alta muntanya al puig des Teix amb zona d'acampada.

---

## 🗺️ Mapa Interactiu (OpenStreetMap)

<iframe width="100%" height="350" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://www.openstreetmap.org/export/embed.html?bbox=2.613%2C39.7045%2C2.6430000000000002%2C39.725500000000004&amp;layer=mapnik&amp;marker=39.715%2C2.628" style="border: 1px solid #ddd; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);"></iframe>
<p style="margin-top: 4px; margin-bottom: 16px;"><small><a href="https://www.openstreetmap.org/?mlat=39.715&amp;mlon=2.628#map=15/39.715/2.628" target="_blank">🗺️ Obrir mapa complet a OpenStreetMap</a></small></p>
...
| **Antelació Permís** | **Reserva online IBANAT** |
| **Contacte / Reserves** | **971 17 76 52 (IBANAT)** |
| **Accés d'Emergència** | **Pista forestal des de Valldemossa** |

---

## 🛠️ Infraestructura disponible
- **Serveis:** Refugi bàsic, Taula, Aixopluc
...
| :--- | :---: | :---: | :---: | :--- |
| **Sa Foradada des de Son Marroig (Deià)** | 7.0 km | Moderada | **4.0 km** | [Veure Ruta](../rutes/sa-foradada-son-marroig.md) |
| **GR-221 Etapa 5: Deià al Port de Sóller** | 10.2 km | Fàcil - Moderada | **4.2 km** | [Veure Ruta](../rutes/gr221-etapa-5-deia-port-soller.md) |
| **Camí des Rafal i Cova de sa Cauba (Deià)** | 6.5 km | Moderada | **4.7 km** | [Veure Ruta](../rutes/cami-des-rafal-deia.md) |
...
| **AEG Capità Angelats** | Sóller | **9.4 km** | [Veure Casal](../agrupaments/aeg-capita-angelats.md) |
